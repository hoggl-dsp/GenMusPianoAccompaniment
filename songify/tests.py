...
from geneticmelodyharmonizer_GBT2 import (chord_strings_to_midi_chords,
                                          note_string_to_midi_note)
...
class TestChordStringsToMidiChords(unittest.TestCase):
    ...
    def test_01(self):
        ...
        c_mayor_chord = [note_string_to_midi_note(note) for note in c_mayor_chord]
        c_minor_chord = [note_string_to_midi_note(note) for note in c_minor_chord]
